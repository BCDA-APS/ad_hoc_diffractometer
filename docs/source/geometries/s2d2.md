...
This geometry is defined by the {ref}`geometry-s2d2` factory
function — see the [source](https://github.com/BCDA-APS/ad_hoc_diffractometer/blob/main/src/ad_hoc_diffractometer/geometries/s2d2.yml) for the complete stage
