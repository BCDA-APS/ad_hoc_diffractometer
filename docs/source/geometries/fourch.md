...
This geometry is defined by the {ref}`geometry-fourch` factory
function — see the [source](https://github.com/BCDA-APS/ad_hoc_diffractometer/blob/main/src/ad_hoc_diffractometer/geometries/fourch.yml) for the complete stage
