...
\hat{y} &= \text{transverse (to our left)} \\
...
\begin{itemize}
  ...
  \item \textbf{S1-2}: sits on S1-1. Rotation axis in the transverse direction ($+\hat{y}$).
...
\begin{itemize}
  ...
  \item \textbf{S2-2}: sits on S2-1. Rotation axis in the transverse direction ($+\hat{y}$).
...
S1-2 & transverse  & $+\hat{y}$ & $+\hat{x}$ toward $+\hat{z}$ \\
\bottomrule
\end{tabular}
\end{center}
...
S2-2 & transverse      & $+\hat{y}$ & $+\hat{x}$ toward $+\hat{z}$ \\
...
\midrule
1 (chosen) & longitudinal & transverse      & vertical     \\
2          & transverse      & vertical     & longitudinal \\
3          & vertical     & longitudinal & transverse      \\
4          & transverse      & longitudinal & vertical     \\
5          & longitudinal & vertical     & transverse      \\
6          & vertical     & transverse      & longitudinal \\
\bottomrule
\end{tabular}
\end{center}

Assignments 1--3 are cyclic (even) permutations of (longitudinal, transverse, vertical);
...
S1-2 & transverse      & $+\hat{y}$ & $+\hat{z}$ & $+\hat{x}$ & $+\hat{x}$ & $+\hat{z}$ & $+\hat{y}$ \\
S2-1 & vertical     & $+\hat{z}$ & $+\hat{x}$ & $+\hat{y}$ & $+\hat{z}$ & $+\hat{y}$ & $+\hat{x}$ \\
S2-2 & transverse      & $+\hat{y}$ & $+\hat{z}$ & $+\hat{x}$ & $+\hat{x}$ & $+\hat{z}$ & $+\hat{y}$ \\
